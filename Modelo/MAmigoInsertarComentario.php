        ...
        if ($_POST['Texto']!= "")
        {
            ...
            //validar foto
             ...
             if ($ban=='si' && $banvi=='si')
             {
                ...
                $uploads_dir = "../Archivos/".$_SESSION['email']."/Coments/";
                ...
                move_uploaded_file($tmp_name,$uploads_dir.$ima);
                 ...
                 $sql="INSERT INTO comentarios (idpub,texto,email,fecha,imagen,video) VALUES ('$idinser','$comen','$correo1','$fechap','$fotoasub','$tub')";    
...
//                 $fotoasub=$uploads_dir.$ima;
                 ...
                 $sql1="INSERT INTO comentarios (idpub,texto,email,fecha,imagen,video) VALUES ('$idinser','$comen','$correo1','$fechap1','no','$tub')";     
////    $sql = "INSERT into tablaimagenes (nombre_archivo) values ('$nombre')";
