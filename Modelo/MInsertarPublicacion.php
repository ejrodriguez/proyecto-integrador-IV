            ...
            //validar foto
             ...
             if ($ban=='si' && $banvi=='si')
             {
                ...
                move_uploaded_file($tmp_name,$uploads_dir.$ima);
                 ...
                 $sql="INSERT INTO publicaciones (email,texto,imagen,video,fecha,enperfilde) VALUES ('$correo1','$comen','$fotoasub','$tub','$fechap','$correo1')";    
////    $sql = "INSERT into tablaimagenes (nombre_archivo) values ('$nombre')";
             ...
             //echo $comen."<br>   ".$ima."<br>    ".$imagen_tipo." <br>  ".$tami." <br> ".$tub. "<br> <a href='javascript:history.back();'>Regresar Y Cambiar Foto</a>";
                 ...
                 $sql1="INSERT INTO publicaciones (email,texto,imagen,video,fecha,enperfilde) VALUES ('$correo1','$comen','no','$tub','$fechap1','$correo1')";    
////    $sql = "INSERT into tablaimagenes (nombre_archivo) values ('$nombre')";
