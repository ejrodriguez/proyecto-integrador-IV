  ...
  <article class="content">
    ...
    $perfil1=  mysql_fetch_array($resultado1);
		   ...
		   ?>
            ...
            <td class="sobre1"> <a href="../Vista/perfil_amigo.php?amigo=<?php echo $user1['iduser']; ?>" style="text-decoration:none; color:#000;"><?php printf($user1['nombre']." ".$user1['apellido']);?></br><?php printf($perfil1['ciudad']." - ".$perfil1['ocupacion']);?></a></td>
      <td align="center">
